...
public class GlobalScope extends Scope {
    ...
    ///////////////////////CONSTANTS////////////////////////
    static final String ILLEGAL_METHOD_DECELERATION = "illegal method deceleration";
    static final int NAME_PLC = 3;
    static final String METHODS_FIRST_PART_REGEX = "\\s*(void)(\\s+)(_*[a-zA-z]+\\w*)\\s*\\(\\s*";
